...
public class Statistics {
    ...
    public static double getAverage(double[] data)
    {
        if (data.length < 1)
            return 0.0;
        double sum = 0.0;
        for (double aData : data) sum = sum + aData;
...
//            return 0.0;
//        double sum = 0.0;
//        for (int aData : data) sum = sum + (double) aData;
//        return (sum / ((double) data.length));
//    }
//
//
...
//        double sum = 0.0;
//        for (int aData : data) {
//            double diff = ((double) aData) - average;
//            sum = sum + diff * diff;
//        }
//        return Math.sqrt(sum / ((double) (data.length - 1)));
//    }
...
//    {
//        double sum = 0.0;
//        for (double aTo_sum : to_sum) sum += aTo_sum;
//        return sum;
//    }
//
//
...
//        System.arraycopy(to_normalize, 0, normalized, 0, normalized.length);
//
...
//            System.arraycopy(to_normalize[i], 0, normalized[i], 0, normalized[i].length);
//        }
//
//        // Perform the normalization
...
//    public static double formatPercentage(double valueToFormat) {
//
//        DecimalFormat df = new DecimalFormat("#.##");
//
//        return Double.valueOf(df.format(valueToFormat));
//
//    }
}